---
title: "BPH All Cells scRNA-seq Analysis"
author: "Nadia Lanman"
date: "7/21/2021"
output:
  html_document:
...
data_1628 <- Read10X(data.dir = "../step1_cellRanger/1628_all/outs/filtered_feature_bc_matrix/")
data_1595 <- Read10X(data.dir = "../step1_cellRanger/1595_all/outs/filtered_feature_bc_matrix/")
data_1652 <- Read10X(data.dir = "../step1_cellRanger/1652_all/outs/filtered_feature_bc_matrix/")
data_1562 <- Read10X(data.dir = "../step1_cellRanger/1562_all/outs/filtered_feature_bc_matrix/")
data_1579 <- Read10X(data.dir = "../step1_cellRanger/1579_all/outs/filtered_feature_bc_matrix/")
...
#saveRDS(seuratobj.1562,"Indiv_all_1562.RDS")
#saveRDS(seuratobj.1579,"Indiv_all_1579.RDS")
#saveRDS(seuratobj.1595,"Indiv_all_1595.RDS")
#saveRDS(seuratobj.1628,"Indiv_all_1628.RDS")
#saveRDS(seuratobj.1652,"Indiv_all_1652.RDS")
...
#pdf("allCells_clusterTree.pdf",height=11,width=8)
#clustree(fortree, assay="SCT",prefix="integrated_snn_res.")
#dev.off()
knitr::include_graphics("allCells_clusterTree.pdf")
```
...
#gp <- g+ggtitle("EPCAM")
#g$data$TNFRSF1B <- rep(0,length(g$data$TNFRSF1A))
#p$data$TNFRSF1B <- rep(0,length(p$data$TNFRSF1B))
#pp <- p+ggtitle("EPCAM")

#ggsave(plot = pp, "VlnPlot_noPoints_EPCAM.png", width = 10, height = 8, units='in' ,dpi=600)
...
Anno <- read.table("/depot-old/pccr/data/core_data/Annotations/Human_20FEB2020.txt", sep="\t",
                   stringsAsFactors = F,header=TRUE, quote="")
